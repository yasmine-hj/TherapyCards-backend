...
topics = Topic.create([{name: 'Relationships'}, {name: 'Self'}, {name: 'Anxiety'}, {name: 'Work'}, {name: 'Anger'}, {name: 'Anger'}])
...
Card.create(question: 'Some people say that addiction is a disease, and others believe it is a choice. What do you think?', topic_id: 6)
Card.create(question: 'What are some rituals or activities that you associate with your addiction that make it difficult to give up? How do you feel about giving them up?', topic_id: 6)
