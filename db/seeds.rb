...
topics = Topic.create([{name: 'Relationships'}, {name: 'Self'}, {name: 'Anxiety'}, {name: 'Work'}, {name: 'Anger'}])
...
User.create(name: 'testname', email: 'testemail@example.com', password: 'testtesttest')
